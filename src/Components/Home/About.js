		...
		<HomeStyles>
			<div className='display-info px-4 pt-4 pb-4'>
				<h4 className='my-1'>
					...
					the latest JavaScript technology. Whether you building your new dream
					or adding to an existing project, hire a top notch developer.
				</h4>
				<div className='row'>
					<div className='col-3' />
					<div className='col-9'>
						...
						<h4 className=' mt-5'>
							JavaScript || React || Bootstrap || GraphQL || FireBase || GitHub
							|| Jira || Linux & iOS || NPM || Nodejs || and More!
						</h4>
					</div>
				</div>
